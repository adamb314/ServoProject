...
class PwmNonlinearityIdentifier(object):
    ...
    def writeLinearizationFunctionToConfigClassString(self, configClassString):
        ...
        if temp != None:
            ...
            out += r'\4{\n'
            out += r'\4    constexpr static std::array<uint16_t, ' + str(lookUpSize) + '> linearizeVec = ' + intArrayToString(self.pwmNonlinearityCompLookUp) + '\n'
            out += r'\n'
    ...
    def getLinearizationFunction(self):
        ...
        out += '{\n'
        out += '    constexpr static std::array<uint16_t, ' + str(lookUpSize) + '> linearizeVec = ' + intArrayToString(self.pwmNonlinearityCompLookUp) + '\n'
        out += '\n'
