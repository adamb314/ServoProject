...
public:
    ...
    class ControlParameters : public SetupConfigHolder::DefaultControlParameters
    {
      public:
        ...
        {
            Eigen::Matrix3f A;
            A << 1.0, 0.0012, 2.9758054287514434e-05 / 2,
                0.0, 0.9977604432525484, 0.049596757145857394 / 2,
                0.0, 0.0, 1.0;
        ...
        {
            Eigen::Matrix3f AInv;
            AInv << 1.0, -0.001202693500343811, 2.989164316993871e-05 / 2,
                0.0, 1.0022445836198426, -0.04970808121454429 / 2,
                0.0, 0.0, 1.0;
        ...
        {
            Eigen::Vector3f B;
            B << 2.9758054287514434e-05 / 2,
                0.049596757145857394 / 2,
                0.0;
...
public:
    static std::unique_ptr<Communication> getCommunicationHandler()
    {
        ...
        com->addCommunicationNode(
                std::make_unique<DCServoCommunicationHandler>(2, createDCServo<ConfigHolder>()));
