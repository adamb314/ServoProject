...
public:
    ...
    class ControlParameters : public SetupConfigHolder::DefaultControlParameters
    {
      public:
        ...
        {
            Eigen::Matrix3f A;
            A << 1.0, 0.0012, 2.9719935703630102e-05 / 2,
                0.0, 0.9990224168326246, 0.04953322617271684 / 2,
                0.0, 0.0, 1.0;
        ...
        {
            Eigen::Matrix3f AInv;
            AInv << 1.0, -0.0012011742477256611, 2.9778099981808076e-05 / 2,
                0.0, 1.0009785397713844, -0.04958169640453182 / 2,
                0.0, 0.0, 1.0;
        ...
        {
            Eigen::Vector3f B;
            B << 2.9719935703630102e-05 / 2,
                0.04953322617271684 / 2,
                0.0;
